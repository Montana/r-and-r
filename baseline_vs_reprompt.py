    ...
    for context_len in context_lens:
        ...
        for question_id, answer_position in itertools.product(question_ids, answer_positions):
            ...
            saferun(
                ...
                return_page=True,
                output_path=f'results/baseline_vs_reprompt/{dataset_name}/{model_name}/c{context_len:d}/baseline/q{question_id:d}/a{answer_position:d}.json'
            )
            ...
            saferun(
                ...
                output_path=f'results/baseline_vs_reprompt/{dataset_name}/{model_name}/c{context_len:d}/reprompt/q{question_id:d}/a{answer_position:d}.json'
            )
