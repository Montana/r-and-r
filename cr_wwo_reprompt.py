...
model_name = 'gpt4'
model = load_model('openai') if model_name == 'gpt4' else load_model('anthropic')
    ...
    for question_id, answer_position in itertools.product(question_ids, answer_positions):
        ...
        for cs in chunk_sizes:
            ...
            saferun(
                ...
                do_chunking=True,
                chunk_size=cs * 1000,
                output_path=f'results/cvr/{dataset_name}/{model_name}/c{context_len:d}/cr{cs:d}k/q{question_id:d}/a{answer_position:d}.json'
            )
            ...
            if cs > 10:
                ...
                saferun(
                    ...
                    do_abbreviate=True,
                    do_chunking=cs != 80,
                    chunk_size=cs * 1000 if cs != 80 else None,
                    output_path=f'results/cvr/{dataset_name}/{model_name}/c{context_len:d}/cr{cs:d}k+reprompt/q{question_id:d}/a{answer_position:d}.json'
                )
